...
from atrailer.apps.customshop.models import Trailer
from atrailer.apps.customshop.views import (MyCheckoutSelectionView,
...
urlpatterns = patterns('',
    ...
    url(r'^checkout/thank_you/$',
        ...
        name='checkout_confirm' # Second step of the checkout process
    ),
    # Orders
    url(r'^orders/$',
